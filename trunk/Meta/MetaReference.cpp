...
// --------------------------- Public MetaReference Methods --------------------------- //


const Result_t MetaReference::GetItems(std::list<MetaPointerItem*> &pointerList) const throw()
{
...
const Result_t MetaReference::CreateItem(MetaPointerItem* &pointerItem) throw()
{
