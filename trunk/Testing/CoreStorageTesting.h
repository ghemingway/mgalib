...
// The fixture for testing all MetaObjIDPair values in any ICoreStorage implementor.
class ICoreStorageParamTest : public ::testing::TestWithParam<MetaObjIDPair> {
protected:
	//	ICoreStorageParamTest() { }
	//	virtual ~ICoreStorageParamTest() { }
	virtual void SetUp() {
		idPair = GetParam();
		ASSERT_NE( idPair.metaID, METAID_NONE );
		ASSERT_NE( idPair.objID, OBJID_NONE );
