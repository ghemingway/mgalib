...
protected:
	ICoreStorage						*_storage;							//!< Underlying storage engine
	CoreMetaProject						*_coreMetaProject;					//!< Associated coreMeta project
	bool								_isDirty;							//!< Dirty flag
	ObjectHash							_objectHash;						//!< Hash of all active CoreObjects
	std::list<Transaction>				_transactionList;					//!< List of all active transactions
